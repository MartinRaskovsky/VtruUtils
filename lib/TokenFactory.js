...
//const TokenUsdtBase = require('../lib/tokenUsdtBase');
...
const sectionMap = new Map([
  ...
  [SEC_USDC_BASE, { Class: TokenUsdcBase, contractId: 'USDC', web3Id: Web3.BASE, network: NET_BASE, digits: 2, format: formatVusdNegNumber, formats: formatVusdNegNumbers }],
