...
const sectionMap = new Map([
  ...
  [SEC_WVTRU,        { Class: TokenCommonEvm,  contractId: 'wVTRU',  web3Id: Web3.VTRU, network: NET_VTRU, digits: 2, format: formatRawNumber,  formats: formatRawNumbers }],
  ...
  [SEC_SEVOX,        { Class: TokenCommonEvm,  contractId: 'SEVOX',  web3Id: Web3.BSC,  network: NET_BSC, digits: 2, format: formatRawNumber,  formats: formatRawNumbers }],
  ...
  [SEC_VTRU_ETH,     { Class: TokenCommonEvm,  contractId: 'VTRU',   web3Id: Web3.ETH,  network: NET_ETH, digits: 2, format: formatRawNumber,  formats: formatRawNumbers }],
  [SEC_VTRU_BSC,     { Class: TokenCommonEvm,  contractId: 'VTRU',   web3Id: Web3.BSC,  network: NET_BSC, digits: 2, format: formatRawNumber,  formats: formatRawNumbers }],
  [SEC_USDC_VTRU,    { Class: TokenCommonEvm,  contractId: 'USDC',   web3Id: Web3.VTRU, network: NET_VTRU, digits: 2, format: formatVusdNumber, formats: formatVusdNumbers }],
  [SEC_USDC_ETH,     { Class: TokenCommonEvm,  contractId: 'USDC',   web3Id: Web3.ETH,  network: NET_ETH, digits: 2, format: formatRawNumber,  formats: formatRawNumbers }],
  [SEC_USDC_BSC,     { Class: TokenCommonEvm,  contractId: 'USDC',   web3Id: Web3.BSC,  network: NET_BSC, digits: 2, format: formatRawNumber,  formats: formatRawNumbers }],
  [SEC_USDC_POL,     { Class: TokenCommonEvm,  contractId: 'USDC',   web3Id: Web3.POL,  network: NET_POL, digits: 2, format: formatVusdNumber, formats: formatVusdNumbers }],
...
class TokenFactory {
  ...
  static create(key, networkMap, formatOutput = false) {
    ...
    const contract = Class === TokenCommonEvm
