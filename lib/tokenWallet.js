...
class TokenWallet {
    ...
    /**
         * Retrieves the VTRU balance for a given wallet without internal error handling.
         * 
         * @param {string} wallet - The wallet address.
         * @returns {Promise<bigint>} The VTRU balance.
    ...
    async getBalances(wallets) {
        //console.log(`tokenWallet::getBalances(${wallets})`);
