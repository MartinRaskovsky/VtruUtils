...
const { sleep } = require("./vtruSystem");
...
class VtruVaultFactory extends VtruContract {
     ...
     */
    constructor(config, web3, contractName = "CreatorVaultFactory") {
        super(config, web3, contractName);
    }
    ...
    async processVaults(limit = Infinity, callback) {
        try {
            ...
            for (let i = 0; i < vaultCount; i++) {
                ...
                const vault = new Vault(vaultAddresses[i], this.config, this.web3);
