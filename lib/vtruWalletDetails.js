 ...
 * 
 * Handles the logic to collect wallet details in the Vtru ecosystem.
...
const WalletContract = require("../lib/libWalletContract");
...
class VtruWalletDetails {
  ...
  constructor(network) {
    ...
    this.walletContract = new WalletContract(vtru);
    ...
    this.ethWalletContract = eth ? new WalletContract(eth) : null;
  }
