...
const { scaleUp, formatNumber, formatNumbers, formatRawNumber } = require("./vtruUtils");
...
class VtruVaultDetails extends VtruWalletDetails {
     ...
     */
    constructor(config, web3, minBalance = 4000) {
        super(config, web3);
        this.config = config;
        this.web3 = web3;
        ...
        try {
            ...
            if (thisHeld >= this.minBalance) {
                ...
                return {
                    ...
                    walletVibes: formatNumbers(walletDetails.walletVibes),
                    walletVerses: formatNumbers(walletDetails.walletVerses),
                    held: formatRawNumber(thisHeld, 0),
                    staked: formatRawNumber(walletDetails.staked, 0),
