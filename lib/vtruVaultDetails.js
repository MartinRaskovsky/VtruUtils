        ...
        try {
            ...
            if (thisHeld >= this.minBalance) {
                ...
                const data = {
                    ...
                    sectionVERSE: full ? formatNumbers(walletDetails.sectionVERSE, 0) : [],
                    sectionVIBE: full ? formatNumbers(walletDetails.sectionVIBE, 0) : [],                   
                    sectionVORTEX: full ? formatNumbers(walletDetails.sectionVORTEX, 0) : [],
                    sectionETH: this.eth ? formatNumbers(walletDetails.sectionETH, 0) : [],
                    sectionBNB: this.bsc ? formatNumbers(walletDetails.sectionBNB, 0) : [],                    
                    sectionSEVOXStaked: this.bsc ? walletDetails.sectionSEVOXStaked : [],
                    totalVTRUHeld: formatRawNumber(thisHeld),
                    totalVTRUStaked: formatRawNumber(walletDetails.totalVTRUStaked),
                    totalVERSE: full ? formatNumber(walletDetails.totalVERSE, 0) : "0",
                    totalVIBE: full ? formatNumber(walletDetails.totalVIBE, 0) : "0",
                    totalVORTEX: full ? formatNumber(walletDetails.totalVORTEX, 0) : "0",
                    totalETH: this.eth ? formatRawNumber(walletDetails.totalETH) : "0",
                    totalBNB: this.bsc ? formatRawNumber(walletDetails.totalBNB) : "0",
                    totalSEVOXStaked: this.bsc ? formatRawNumber(walletDetails.totalSEVOXStaked) : "0",
                };
