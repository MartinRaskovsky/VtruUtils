...
const {
  SEC_VTRU, SEC_ETH, SEC_AVAX, SEC_BNB, SEC_POL, SEC_SOL, SEC_TEZ, SEC_ETH_ARB,
  SEC_ETH_OPT, SEC_ETH_BASE, SEC_VTRU_ETH, SEC_VTRU_BSC, SEC_USDC_VTRU, SEC_USDC_ETH, SEC_USDC_BSC, SEC_USDC_POL,
  SEC_USDC_SOL, SEC_USDC_ARB, SEC_USDC_OPT, SEC_USDC_BASE, SEC_USDC_AVAX, SEC_USDT_ETH, SEC_USDT_POL, SEC_USDT_ARB,
  SEC_USDT_OPT, SEC_USDT_AVAX, SEC_VTRU_STAKED, SEC_SEVOX_STAKED, SEC_VERSE, SEC_VIBE, SEC_VORTEX, SEC_VTRO,
  SEC_VUSD, SEC_WVTRU, SEC_SEVO, SEC_SEVOX, SEC_V3DEX, SEC_VITDEX
} = require('../shared/constants');

const sectionKeys = [
  SEC_VTRU, SEC_ETH, SEC_AVAX, SEC_BNB, SEC_POL, SEC_SOL, SEC_TEZ, SEC_ETH_ARB, SEC_ETH_OPT, SEC_ETH_BASE, SEC_VTRU_ETH, SEC_VTRU_BSC, SEC_USDC_VTRU, SEC_USDC_ETH, SEC_USDC_BSC, SEC_USDC_POL, SEC_USDC_SOL, SEC_USDC_ARB, SEC_USDC_OPT, SEC_USDC_BASE, SEC_USDC_AVAX, SEC_USDT_ETH, SEC_USDT_POL, SEC_USDT_ARB, SEC_USDT_OPT, SEC_USDT_AVAX, SEC_VTRU_STAKED, SEC_SEVOX_STAKED, SEC_VERSE, SEC_VIBE, SEC_VORTEX, SEC_VTRO, SEC_VUSD, SEC_WVTRU, SEC_SEVO, SEC_SEVOX, SEC_V3DEX, SEC_VITDEX
];
