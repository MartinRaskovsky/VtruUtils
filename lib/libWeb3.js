 ...
 * Supports Vitruveo(VTRU), Binance(BSC) and Ethereum(totalETH) networks.
...
class Web3 {
  ...
  constructor(id) {
    ...
    Web3.currency[Web3.VTRU] = "VTRU";
    Web3.currency[Web3.BSC]  = "BNB";
    Web3.currency[Web3.ETH]  = "ETH";
    ...
    switch (id) {
      ...
      case Web3.BSC:
        ...
        break;
        case Web3.ETH:
          this.rpcUrl = "https://rpc.mevblocker.io";
          this.jsonPath = "CONFIG_JSON_ETH_PATH";
          break;
      default:
  ...
  async getWalletRawBalance(wallet) {
    try {
      ...
      console.error(`❌ Not valid wallet ${wallet}`);
      return 0n;
    }
  }
