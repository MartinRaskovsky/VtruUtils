...
class TokenCommon extends VtruContract {
    ...
    async fetchBalance(wallet) {
        try {
            ...
            console.error(`❌ Error fetch ${this.tokenType} balance for wallet ${wallet}:`, error.message);
            return null;
        }
    }
    ...
    async getBalances(wallets) {
        ...
        //console.log("TokenCommon: getBalances");
        return await processInBatches(wallets, this.fetchBalance.bind(this));
    }
    ...
    async getDetails(wallets) {
        ...
        //console.log("TokenCommon: getDetails");
        return await processInBatches(wallets, this.fetchDetail.bind(this));
    }
}
