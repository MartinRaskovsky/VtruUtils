...
class TokenCommon extends VtruContract {
    ...
    async getBalances(wallets) {
        ...
        return await processInBatches(wallets, this.innerFetchBalance.bind(this), batchSize);
    }
    ...
    async getDetails(wallets) {
        ...
        const batchSize = (this.web3.getId && this.web3.getId() === Web3.POL) ? 8 : 30;
        const details = await processInBatches(wallets, this.innerFetchDetail.bind(this), batchSize);
