        ...
        try {  
            ...
            const walletDetails = await super.get(wallets, true);
                ...
                const data = {
                    ...
                    totalVTRUHeld: formatRawNumber(walletDetails.totalVTRUHeld),
                    totalVTRUStaked: formatRawNumber(walletDetails.totalVTRUStaked),
                    totalVERSE: formatNumber(walletDetails.totalVERSE, 0),
                    totalVIBE: formatNumber(walletDetails.totalVIBE, 0),
                    totalVORTEX: formatNumber(walletDetails.totalVORTEX, 0),
