...
/**
 * Retrieves V3DEX held balance for given wallet addresses.
 *
...
const { SEC_V3DEX } = require('../shared/constants');

const TITLE = SEC_V3DEX;
 ...
 */
function showUsage() {
    console.log("\nUsage: getBalanceV3dex.js [options] <wallet1> <wallet2> ... <walletN>\n");
    console.log("Options:");
...
async function runBalances(vaultAddress, wallets, formatOutput) {
    try {
        ...
        const token = new TokenV3dex(vtru);
        ...
        console.error("❌ Error retrieving V3DEX held balances:", error.message);
    }
}
